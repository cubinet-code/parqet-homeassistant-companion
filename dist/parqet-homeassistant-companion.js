  ...
  `,e([ut()],It.prototype,"selected",void 0),It=e([dt("parqet-interval-selector")],It);let Tt=class extends lt{constructor(){super(...arguments),this.portfolioId="",this._data=null,this._loading=!1,this._interval="1y",this._error=""}connectedCallback(){var t,e;super.connectedCallback(),this._interval=null!==(e=null===(t=this.config)||void 0===t?void 0:t.default_interval)&&void 0!==e?e:"1y",this._load()}updated(t){t.has("portfolioId")&&this.portfolioId&&this._load()}async _load(){if(this.portfolioId&&this.client){this._loading=!0,this._error="";try{const t=await this.client.getPerformance(this.portfolioId,{type:"relative",value:this._interval});this._data=t.performance}catch(t){this._error=t instanceof Error?t.message:String(t)}finally{this._loading=!1}}}async _onIntervalChange(t){this._interval=t.detail.interval,await this._load()}_sym(){var t,e;return null!==(e=null===(t=this.config)||void 0===t?void 0:t.currency_symbol)&&void 0!==e?e:"€"}_fmtCurrency(t){return null==t?"—":`${this._sym()}${t.toLocaleString(void 0,{minimumFractionDigits:2,maximumFractionDigits:2})}`}_fmtPct(t){if(null==t)return"—";const e=100*t;return`${e>=0?"+":""}${e.toFixed(2)}%`}_kpiClass(t){return null==t?"":t>0?"positive":t<0?"negative":""}render(){var t,e,o,i,r,a,s,n,l,c,d,p,h,u,v,f,_,g,m,y,b,x,$,w;const k=this._data;return F`
      ...
      ${k?F`
            <div class="kpi-grid ${(null===(t=this.config)||void 0===t?void 0:t.compact)?"compact":""}">
              ...
              ${this._renderKpi("XIRR",this._fmtPct(null===(i=null===(o=k.kpis)||void 0===o?void 0:o.inInterval)||void 0===i?void 0:i.xirr),null===(a=null===(r=k.kpis)||void 0===r?void 0:r.inInterval)||void 0===a?void 0:a.xirr)}
              ${this._renderKpi("TTWROR",this._fmtPct(null===(n=null===(s=k.kpis)||void 0===s?void 0:s.inInterval)||void 0===n?void 0:n.ttwror),null===(c=null===(l=k.kpis)||void 0===l?void 0:l.inInterval)||void 0===c?void 0:c.ttwror)}
              ...
              ${(()=>{var t,e,o,i;const r=null!==(e=null===(t=k.valuation)||void 0===t?void 0:t.atIntervalStart)&&void 0!==e?e:0,a=null!==(i=null===(o=k.valuation)||void 0===o?void 0:o.atIntervalEnd)&&void 0!==i?i:0,s=r>0?(a-r)/r:null;return this._renderKpi("Period Return",this._fmtPct(s),s)})()}
              ${this._renderKpi("Realized Gain",this._fmtCurrency(null===(f=null===(v=k.realizedGains)||void 0===v?void 0:v.inInterval)||void 0===f?void 0:f.gainGross),null===(g=null===(_=k.realizedGains)||void 0===_?void 0:_.inInterval)||void 0===g?void 0:g.gainGross)}
              ${this._renderKpi("Dividends",this._fmtCurrency(null===(y=null===(m=k.dividends)||void 0===m?void 0:m.inInterval)||void 0===y?void 0:y.gainGross))}
              ${this._renderKpi("Fees",this._fmtCurrency(null===(x=null===(b=k.fees)||void 0===b?void 0:b.inInterval)||void 0===x?void 0:x.fees))}
              ${this._renderKpi("Taxes",this._fmtCurrency(null===(w=null===($=k.taxes)||void 0===$?void 0:$.inInterval)||void 0===w?void 0:w.taxes))}
            </div>
